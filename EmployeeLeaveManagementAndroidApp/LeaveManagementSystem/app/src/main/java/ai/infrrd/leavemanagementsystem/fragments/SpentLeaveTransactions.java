...
public class SpentLeaveTransactions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFragmentView = inflater.inflate(R.layout.fragment_leave_transactions_spent, container, false);
    ...
    public void fillLeaveDetails() {
        ...
        List<LeaveHistoryModel> leaveHistoryModelList = databaseHandler.getAllEmployeeLeaveDetailsByCategory(Constants.LEAVE_TYPE_SICK_LEAVE);
