...
public class ExperienceAdapter extends RecyclerView.Adapter<ExperienceAdapter.ExperienceViewHolder> {
    ...
    public class ExperienceViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView vhCompanyLogo = null;
        ...
        public ExperienceViewHolder(View view) {
            ...
            vhCompanyLogo = (ImageView) view.findViewById(R.id.imageview_company_logo);
        }
    }
    ...
    public void onBindViewHolder(ExperienceAdapter.ExperienceViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(mExperienceDetails.get(position).getCompanyLogo())
                .placeholder(R.drawable.default_image).fitCenter()
                .into(holder.vhCompanyLogo);
        if (!mShowEditicon) {
