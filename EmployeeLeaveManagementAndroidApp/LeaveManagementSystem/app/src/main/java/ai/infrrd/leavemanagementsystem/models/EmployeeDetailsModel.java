...
public class EmployeeDetailsModel {
    ...
    public float getTotalLeaveCount() {
        return totalLeaveCount;
    }

    public void setTotalLeaveCount(float totalLeaveCount) {
    ...
    public int getTotalWorkFromHome() {
        return totalWorkFromHome;
    }

    public void setTotalWorkFromHome(int totalWorkFromHome) {
