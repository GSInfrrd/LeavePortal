 ...
 * Returns a fragment that contains a list of all leave transactions.
 */

public class AllLeaveTransactions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFragmentView = inflater.inflate(R.layout.fragment_leave_transactions_all, container, false);
    ...
    public void fillLeaveDetails() {
        ...
        List<LeaveHistoryModel> leaveHistoryModelList = databaseHandler.getAllEmployeeLeaveDetails();
